...
private:
    ...
    static esp_err_t handleGetSavedNetworks(httpd_req_t* req);
    static esp_err_t handleRemoveNetwork(httpd_req_t* req);
    ...
    static esp_err_t handleEditReminder(httpd_req_t* req);
    ...
    static esp_err_t handleTestLlmApi(httpd_req_t* req);
    static esp_err_t handleTestVoiceApi(httpd_req_t* req);
