...
enum class CountdownState {
    ...
    Expired         // Pulsing 00:00 until dismissed (3 min timeout)
};
...
public:
    ...
    /** Get pulse brightness for expired state (0.0 to 1.0, sinusoidal) */
    float getExpiredPulse() const;
...
private:
    ...
    uint32_t expiredStart;      // millis() when expired flash began
