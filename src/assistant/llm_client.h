...
/** Maximum tool definitions (14 device + up to 16 MCP per server) */
#define LLM_MAX_TOOLS 48
...
public:
    ...
    /**
     * @brief Queue tool result in history without sending
     * Use for batching multiple tool results before a single API call.
     */
    ...
    /**
     * @brief Execute a tool using the registered executor
     */
    String executeTool(const char* name, const char* input) {
